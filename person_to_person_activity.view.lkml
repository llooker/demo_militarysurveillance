view: person_to_person_activity {
  ...
  dimension: connected_person_photo {
    ...
    html:
    {% if value < 95 %}
    <img src="https://www.evernote.com/shard/s710/res/2614f06a-6d08-4a76-a5fe-1b4ea1fa0d18" width="100" />
    {% elsif value > 94 and value < 104 %}
    <img src="https://www.evernote.com/shard/s710/res/b3711572-8f8b-48fb-a819-56467d056d27" width="100"/>
    {% elsif value > 103 and value < 117 %}
    <img src="https://www.evernote.com/shard/s710/res/04219275-d63a-4883-9eca-ef3e3978c7e8" width="100"/>
    {% elsif value > 116 and value < 156 %}
    <img src="https://www.evernote.com/shard/s710/res/42f46762-1a17-4038-bd55-33107c7ea730" width="100"/>
    {% else %}
    <img src="https://www.evernote.com/shard/s710/res/5432506f-4a58-41f9-86a7-9fcc1dad1efc" width="100" />
    {% endif %}
    ;;
  }
