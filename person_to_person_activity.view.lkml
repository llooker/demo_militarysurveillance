view: person_to_person_activity {
  ...
  dimension: connected_person_photo {
    ...
    html:
    {% if value < 95 %}
    <img src="https://backpackingman.com/wp-content/uploads/2016/10/afghanistan-wakhan-valley.jpg" height="60" width="85" />
    {% elsif value > 94 and value < 104 %}
    <img src="https://cbsdenver.files.wordpress.com/2014/02/pooley_don-hostage-suspect-mug-shot-use-this-one.jpg?w=420&h=236" height="60" width="85"/>
    {% elsif value > 103 and value < 117 %}
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQs3vY3F0Y6TYHnSGcpRjAThrqEkssfNJ01p7QE-lmJ8w3V3VzJ" height="60" width="65"/>
    {% elsif value > 116 and value < 156 %}
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQr9y4KPu65-luwp3v24IVVA1bK949nqIkfCuhT9mH3R8AtRB77" height="60" width="85"/>
    {% else %}
    <img src="https://newscdn.weigelbroadcasting.com/oYfce-1495591096-17070-blog-11866057_G.jpg" height="60" width="85" />
    {% endif %}
    ;;
  }
